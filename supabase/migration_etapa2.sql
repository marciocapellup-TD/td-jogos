...
-- profiles.timezone: fuso usado para validar janelas de horário (hidratação).
-- Default 'America/Sao_Paulo'. Usuários fora do BR (ex: Mariane em Londres) recebem o fuso próprio.
...
--    - Hidratacao: 1 por horário/dia + janela de horário (manha 0-11, tarde 12-17, noite 18-23)
--      usando profiles.timezone (default America/Sao_Paulo).
